...
const DEP_LOCS = [['icons'], ['browser_action', 'default_icon'], ['browser_action', 'default_popup'], ['page_action', 'default_icon'], ['page_action', 'default_popup'], ['action', 'default_icon'], ['action', 'default_popup'], ['background', 'scripts'], ['chrome_url_overrides'], ['devtools_page'], ['options_ui', 'page'], ['sandbox', 'pages'], ['sidebar_action', 'default_icon'], ['sidebar_action', 'default_panel'], ['storage', 'managed_schema'], ['theme', 'images', 'theme_frame'], ['theme', 'images', 'additional_backgrounds'], ['user_scripts', 'api_script']];
...
async function collectDependencies(asset, program, ptrs, hmrOptions) {
  ...
  if (isMV2) {
    ...
    if (hot) {
      ...
      csp.extension_pages = cspPatchHMR(csp.extension_pages, `http://${(hmrOptions === null || hmrOptions === void 0 ? void 0 : hmrOptions.host) || 'localhost'}`); // Sandbox allows eval by default
